...
struct OneEuroFilter {
  ...
  // beta: higher = faster response to quick motion (less lag at speed)
  // d_cutoff: smoothing of the derivative estimate
  OneEuroFilter() : min_cutoff(0.5f), beta(0.01f), d_cutoff(1.0f) {}
